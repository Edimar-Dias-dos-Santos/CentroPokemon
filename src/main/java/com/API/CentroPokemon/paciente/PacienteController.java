...
public class PacienteController {
    ...
    public ResponseEntity<List<PacienteRepresentation.Lista>> buscarPaciente(
        ...
        List<PacienteRepresentation.Lista> listaFinal =
                PacienteRepresentation.Lista.from(pacienteList.getContent());
    ...
    public ResponseEntity<PacienteRepresentation.Detalhes> atualizarPaciente(
    ...
    public ResponseEntity<PacienteRepresentation.Detalhes> buscarUmPaciente(
            @PathVariable Long idPaciente) {
